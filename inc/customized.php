          ...
          <div class="flex-1">
            ...
            <div>
              <select class="form-select form-select-sm" aria-label="Navbar position" data-theme-control="navbarPosition">
                <option value="vertical" data-page-url="modules/components/navs-and-tabs/vertical-navbar.php">Vertical</option>
                <option value="top" data-page-url="modules/components/navs-and-tabs/top-navbar.php">Top</option>
                <option value="combo" data-page-url="modules/components/navs-and-tabs/combo-navbar.php">Combo</option>
                <option value="double-top" data-page-url="modules/components/navs-and-tabs/double-top-navbar.php">Double Top</option>
              </select>
            </div>
          </div>
        </div>
